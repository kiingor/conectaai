-- RAG por setor — agente de retaguarda (n8n)
-- Migration idempotente: pode ser rodada mesmo se partes já estiverem aplicadas.

-- Extensões necessárias
CREATE EXTENSION IF NOT EXISTS vector;

-- Campos de IA + agente adicionados ao setor
...
ALTER TABLE setores ADD COLUMN IF NOT EXISTS agente_prompt     TEXT;
ALTER TABLE setores ADD COLUMN IF NOT EXISTS rag_ativo          BOOLEAN DEFAULT false;
